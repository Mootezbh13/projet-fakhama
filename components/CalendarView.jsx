      ...
      <div className="flex flex-col gap-3 mb-4 sm:flex-row sm:justify-between sm:items-center">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => navigateMonth(-1)} className="shrink-0 px-3 py-1 border rounded-md hover:bg-gray-50 text-gray-700">←</button>
            <span className="px-1 sm:px-4 py-1 font-medium text-gray-900 text-sm sm:text-base whitespace-nowrap capitalize">
