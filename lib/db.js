// lib/db.js
// Fonctions de mapping entre le modèle JS de l'app et les colonnes Supabase.
...
export const maintenanceToRow = (m) => ({
  id: m.id, date: m.date, kilometrage: m.kilometrage,
  type: m.type, description: m.description || null, cout: m.cout,
});
